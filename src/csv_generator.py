"""This module processes images by generating descriptive metadata using GPT and saves the data to a CSV file."""
...
class CSVGenerator:
    """
    A class to facilitate image description generation using OpenAI's GPT model and create a CSV file.
